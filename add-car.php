        ...
        ***********************************-->
                    ...
                    <div class="login-form">
                        ...
                        <form action="" method="POST" novalidate enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-5">
                                <label>Price</label>
                                <input type="text" name="carprice" class="form-control" placeholder="Car price">
                            </div>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="carcondition" class="form-control" placeholder="YCar condition">
                            </div>
                            <div class="form-group col-md-5" style="margin-left: 50px;">
                                <label>Mileage</label>
                                <input type="text" name="carmileage" class="form-control" placeholder="Car mileage">
                            </div>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="cartransmission" class="form-control" placeholder="Car trabsmission">
                            </div>
                            <div class="form-group col-md-5" style="margin-left: 50px;">
                                <label>Fuel Type</label>
                                <input type="text" name="carfueltype" class="form-control" placeholder="Car fuel type">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Year</label>
                                <input type="text" name="caryear" class="form-control" placeholder="Car year">
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="cardesc" class="form-control" placeholder="Car description" cols="30" rows="40"></textarea>
                            </div>

                            <div class="form-group">
                                <label>Brand</label>
                                <input type="text" name="carbrand" class="form-control" placeholder="Car brand (BMW, audi, mercedes, ferrari)">
                            </div>
                            
                            <div class="d-flex align-items-center">
                                <button type="submit" name="submit" class="theme-btn"><i class="far fa-sign-in"></i> Add Car</button>
                            </div>
                        </form>
        ...
        <?php 
         ...
         if(isset($_POST['submit'])){
          ...
          $p_insertquery = "insert into cars(name, price, image, cond, mileage, transmission, fueltype, year, description, brand) values('$carname', '$carprice', '$r_destfile', '$carcondition', '$carmileage', '$cartransmission', '$carfueltype', '$caryear', '$cardesc', '$brand')";
