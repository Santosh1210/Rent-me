        ...
        <div class="login-area py-120">
            <div class="container">
                <div class="col-md-5 mx-auto" style="text-align: center;">
                    ...
                    <h3 style="color: green">Your Payment is Successfull</h3>

                    <script>
    setTimeout(function() {
      window.location.href = 'profile-order.php'; // Replace 'https://example.com' with the URL you want to redirect to
