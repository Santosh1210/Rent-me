                    ...
                    <div class="col-lg-10">
                        <div class="user-profile-wrapper">
                            <div class="user-profile-card profile-ad">
                                <div class="user-profile-card-header">
                                    <h4 class="user-profile-card-title">Order Lists</h4>
                      ...
                      ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $u_res['first_name']; ?> <?php echo $u_res['last_name']; ?></td>
                                                    <td><?php echo $p_res['name']; ?></td>
                                                    <td><img src="<?php echo $p_res['image']; ?>" style="width: 100px;" alt=""></td>
                                                    <td>S<?php echo $p_res['price']; ?></td>
