                    ...
                    <div class="login-form">
                        ...
                        <form action="" method="POST" novalidate enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="carname" class="form-control" value="<?php echo $p_res['name'] ?>" placeholder="Car name">
                            </div>
                            <div class="d-flex">
                            <div class="form-group col-md-5">
                                <label>Price</label>
                                <input type="text" name="carprice" class="form-control" value="<?php echo $p_res['price'] ?>" placeholder="Car price">
                            </div>
                            <div class="form-group col-md-5" style="margin-left: 50px;">
                                <label>Image</label>
                                <input type="file" name="carimage" class="form-control" placeholder="Car image">
                            </div>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="carcondition" class="form-control" value="<?php echo $p_res['cond'] ?>" placeholder="YCar condition">
                            </div>
                            <div class="form-group col-md-5" style="margin-left: 50px;">
                                <label>Mileage</label>
                                <input type="text" name="carmileage" class="form-control" value="<?php echo $p_res['mileage'] ?>" placeholder="Car mileage">
                            </div>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="cartransmission" class="form-control" value="<?php echo $p_res['transmission'] ?>" placeholder="Car trabsmission">
                            </div>
                            <div class="form-group col-md-5" style="margin-left: 50px;">
                                <label>Fuel Type</label>
                                <input type="text" name="carfueltype" class="form-control" value="<?php echo $p_res['fueltype'] ?>" placeholder="Car fuel type">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Year</label>
                                <input type="text" name="caryear" class="form-control" value="<?php echo $p_res['year'] ?>" placeholder="Car year">
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="cardesc" class="form-control" placeholder="Car description" cols="30" rows="40" value="<?php echo $p_res['description'] ?>"><?php echo $p_res['name'] ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Brand</label>
                                <input type="text" name="brand" class="form-control" value="<?php echo $p_res['brand'] ?>" placeholder="Car brand (BMW, audi, mercedes, ferrari)">
                            </div>
                            
                            <div class="d-flex align-items-center">
                                <button type="submit" name="submit" class="theme-btn"><i class="far fa-sign-in"></i> Edit Car</button>
                            </div>
                        </form>
        ...
        <?php 
         ...
         if(isset($_POST['submit'])){
          ...
          $carbrand = $_POST['brand'];
            ...
            $p_filename = $carimage['name'];
            $p_filepath = $carimage['tmp_name'];
            $p_fileerror = $carimage['error'];
            if($p_fileerror ==0){ 
          ...
          $p_insertquery = "update cars set name='$carname', price='$carprice', image='$p_destfile', cond='$carconditipon', mileage='$carmileage', transmission='$cartransmission', fueltype='$carfueltype', year='$caryear', description='$cardescription' where id=$id";
          ...
          if($p_iquery){
               ...
               ?>
                 <script type="text/javascript">
                     location.href = "admin-inventory.php";
                 </script>
            ...
            $image = $p_res['image'];
            $p_insertquery = "update cars set name='$carname', price='$carprice', image='$image', cond='$carconditipon', mileage='$carmileage', transmission='$cartransmission', fueltype='$carfueltype', year='$caryear', description='$cardescription', brand='$carbrand' where id=$id";
          $p_iquery = mysqli_query($con, $p_insertquery);
