...
<?php } ?>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/about/Lorbek.png)">
            <div class="container">
                <h2 class="breadcrumb-title">Car Parts Profile</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Car Parts Profile</li>
                </ul>
            </div>
        </div>
        <!-- Car details end -->
                      ...
                      <?php } ?>
                        ...
                        <div class="col-lg-4">
                            <div class="car-single-widget car-item">
                               ...
                               <a href="./scripts/carparts-addtocart-script.php?id=<?php echo $p_res['id'] ?>"><button class="theme-btn"><i class="far fa-cart-plus"></i> Add to Cart</button></a>
          ...
          if($p_iquery){
               ...
               ?>
                 <script type="text/javascript">
                     ...
                     location.href = "carparts-profile.php?id=<?php echo $id ?>";
                 </script>
