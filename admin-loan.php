            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="user-profile-wrapper">
                            <div class="user-profile-card profile-ad">
                                <div class="user-profile-card-header">
                                    <h4 class="user-profile-card-title">Loan Lists</h4>
                       ...
                       $p_selectquery = "select * from loan";
                      ...
                      ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $p_res['first_name']; ?> <?php echo $p_res['last_name']; ?></span></span></td>
                                                    <td><?php echo $p_res['birth_date']; ?></span></td>
                                                    <td>$<?php echo $p_res['amount']; ?></span></td>
                                                    <td><?php echo $p_res['loan_id']; ?></span></td>
                                                    <td><a href="<?php echo $p_res['loan_proof']; ?>"><img src="<?php echo $p_res['loan_proof']; ?>" style="width: 50px" alt=""></a></td>
                                                    
                                                    <td><?php echo $p_res['status'] == 0 ? '<span class="badge badge-info">pending</span>' : '<span class="badge badge-success">approved</span>'; ?>
                                                    <td>
                                                       <a href="./scripts/approve-loan.php?id=<?php echo $p_res['id'] ?>&user_id=<?php echo $p_res['user_id']; ?>" class="btn btn-outline-success btn-sm rounded-2" data-bs-toggle="tooltip" title="Approve"><i class="far fa-check"></i></a>
