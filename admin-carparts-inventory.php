                        ...
                        <div class="col-md-12">
                            <div class="car-sort">
								...
								<div class="nav-right-btn mt-2">
                                	<a href="add-carparts.php" class="theme-btn"><span class="far fa-plus-circle"></span>Add Car Parts</a>
                            	</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="car-item">
                                    ...
                                    <div class="car-img">
                                        ...
                                        <img src="<?php echo $p_res['image']; ?>" style="width: 100px;" alt="">
                                    ...
                                    <div class="car-content">
                                        ...
                                        <div class="car-footer">
                                            ...
                                            <a href="edit-carparts.php?id=<?php echo $p_res['id']; ?>" class="theme-btn"><span class="far fa-pencil"></span>Edit</a>
                                            <a href="./scripts/delete-carparts-script.php?id=<?php echo $p_res['id']; ?>" class="theme-btn"><span class="far fa-trash"></span>Delete</a>
                                            </div>
