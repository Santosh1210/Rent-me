                    ...
                    <div class="login-form">
                        ...
                        <form action="" method="POST" novalidate enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-5">
                                <label>Price</label>
                                <input type="text" name="partprice" class="form-control" placeholder="Part price">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="partdesc" class="form-control" placeholder="Part description" cols="30" rows="40"></textarea>
                            </div>
                            
                            <div class="d-flex align-items-center">
                                <button type="submit" name="submit" class="theme-btn"><i class="far fa-sign-in"></i> Add Part</button>
                            </div>
                        </form>
...
include './includes/connection.php';
         ...
         if(isset($_POST['submit'])){
          ...
          $p_insertquery = "insert into carparts(name, price, image, description) values('$partname', '$partprice', '$r_destfile', '$partdesc')";
